...
|---------|-------------|------|
| [**IAN**](https://github.com/Camilo-Hernandez/basic_ian_api) | AI assistant for neuroimmunology research — MCP server prototype evolving into a full RAG pipeline. Built for Neuroinmune SAS. | `Python` `MCP` `LLM` `RAG` |
| [**EmesDespachos**](https://github.com/Camilo-Hernandez/EmesDespachos) | Android dispatching app for logistics operations, built with Clean Architecture | `Android` `Jetpack Compose` `Clean Architecture` `Kotlin` |
| [**Waxio**](https://github.com/Camilo-Hernandez/Waxio) | Cross-platform inventory and quotation management app for small businesses | `Kotlin Multiplatform` `Compose Multiplatform` `SQLDelight` |
| [**WhatsApp Automations**](https://github.com/Camilo-Hernandez/whatsapp_desktop_automations) | Desktop automation toolkit for WhatsApp Desktop on Windows — no external APIs, zero dependencies | `Python` `Win32` `Automation` `Windows` |
